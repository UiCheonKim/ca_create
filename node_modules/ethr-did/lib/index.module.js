...
class EthrDID {
  ...
  addDelegate(delegate, delegateOptions, txOptions = {}) {
    try {
      ...
      return Promise.resolve(_this3.lookupOwner()).then(function (owner) {
        return Promise.resolve(_this3.controller.addDelegate((delegateOptions == null ? void 0 : delegateOptions.delegateType) || DelegateTypes.veriKey, delegate, (delegateOptions == null ? void 0 : delegateOptions.expiresIn) || 86400, { ...txOptions,
          from: owner
        })).then(function (receipt) {
          return receipt.transactionHash;
        });
  ...
  createSigningDelegate(delegateType, expiresIn = 86400) {
    try {
      ...
      _this7.signer = ES256KSigner(kp.privateKey, true);
